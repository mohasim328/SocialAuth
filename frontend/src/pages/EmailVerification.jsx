...
const EmailVerification = () => {
    ...
    const hendleChange = (index , value) =>{
                    ...
                    <div className='flex justify-between'>
                    {
                        code.map( (digit,index) =>(
                            <input
                             ...
                             maxLength='6'
                             value={digit}
                             onChange={ (e) => hendleChange(index, e.target.value)}
                             onKeyDown={ (e) => hendleKeyDown(index, e)}
                             className='h-11 w-11 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-gray-900 rounded-lg focus:border-green-500 focus:outline-none'
                            />
                        ))
